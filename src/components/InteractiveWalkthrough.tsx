...
const TOUR_STEPS: WalkthroughStep[] = [
  ...
  {
    target: 'data-tour-schema-visualizer',
    title: '5. SQL Schema Explorer & ERD Visualizer',
    description: 'Inspect live table structures, columns, data types, primary & foreign key relationships, and preview live table rows (top 50) directly inside the app.',
    position: 'bottom',
  },
  {
    target: 'data-tour-transfer-backup',
    title: '6. Wi-Fi & Bluetooth Backup Transfer',
    description: 'Stream multi-gigabyte .bacpac and .bak files directly between Windows and Linux machines over your local Wi-Fi or Bluetooth with zero file size limits.',
    position: 'bottom',
  },
  {
    target: 'data-tour-theme-switcher',
    title: '7. High-Contrast Theme Engine',
    description: 'Switch between 5 tailored high-contrast themes (Bio-Pulse Lime, Hyper Mint, Sage Plum, Solar Sunset, Olive Moss) designed for readability and focus.',
    position: 'bottom',
  },
  {
    target: 'data-tour-run-button',
    title: '8. Non-Shell Secure Execution',
  ...
  },
  {
    ...
    title: '9. Real-Time Streaming Terminal',
