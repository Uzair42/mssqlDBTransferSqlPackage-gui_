...
export const LogConsole: React.FC<LogConsoleProps> = ({
  ...
  return (
    <div data-tour-log-console="true" className="bg-forest-950 border border-forest-800 rounded-2xl flex flex-col h-full overflow-hidden shadow-2xl">
      {/* Console Header Bar */}
      <div className="bg-forest-900 px-4 py-3 border-b border-forest-800 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-2 pl-2 border-l border-forest-800">
            <TerminalConsoleIcon className="w-4 h-4 text-emerald-400" />
        ...
        <div className="flex items-center space-x-2">
          ...
          <div className="relative">
            ...
            />
            <SearchFilterIcon className="w-3 h-3 text-forest-600 absolute left-2 top-2" />
          </div>
      ...
      >
        {filteredLogs.length === 0 ? (
          <div className="h-full flex flex-col items-center justify-center text-forest-600 space-y-2 py-12">
            <TerminalConsoleIcon className="w-8 h-8 text-forest-700 stroke-[1.5]" />
